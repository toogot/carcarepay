...
<html>
  ...
  <body>
    <%@include file="../common/head.jsp" %> <% if(loginUser != null){%>
    <div class="enroll-wrap">
      <form
        action="<%=contextPath %>/enroll.st"
        method="post"
          ...
          <tr>
            ...
            <td>
              <input
                ...
                required
              /><button id="searchAdd" type="button" onclick="searchAddress();">
                주소검색
              </button>
            </td>
          </tr>
