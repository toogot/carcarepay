...
public class EventPageController extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    ArrayList<Event> list = new EventService().selectEventList(pi, orderType);
    ...
    if (request.getParameter("pageFin") == null) {
      currentPageFin = 1;
    } else {
      currentPageFin = Integer.parseInt(request.getParameter("pageFin"));
    }
    ...
    PageInfo piFin = new PageInfo(listCountFin, currentPageFin, pageLimitFin, boardLimitFin, maxPageFin, startPageFin,
        endPageFin);
    ArrayList<Event> listFin = new EventService().selectFinEventList(piFin, orderType);
