...
public class adminMemberListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 개수
		listCount = new AdminService().memberListCount();
		...
		ArrayList<Member> m = new AdminService().selectMemberList(pi);
	...
	request.getRequestDispatcher("views/admin/admin_memberList.jsp").forward(request, response);;
